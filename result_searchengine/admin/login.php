...
if(isset($_REQUEST['rLog'])){
    if($_REQUEST['rEmail']==""||$_REQUEST['rPass']==""){
        ...
        $sql="SELECT rEmail,rPass,rLog from userregistration_tb1 where rEmail='$rEmail' AND rPass='$rPass'";
        ...
        $log=$row['rLog'];
            $log=$log+1;
            $sql1="UPDATE userregistration_tb1 SET rLog = '$log' WHERE rEmail ='$rEmail'";
